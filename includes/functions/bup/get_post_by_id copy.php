...
{
    if(empty($params) || $params['id']=='' ||empty($params['return_type']) || !isset($params['return_type']) || $params['return_type']==''){
        echo "<div class='error'>Please provide required parameters that are: id and return_type</div>";
        die();
    } 
